...
# rspec-stubbed_env Rakefile v7.1.13 - 2026-08-31
...
# rake install                                # Build and install rspec-stubbed_env-1.0.0.gem in...
# rake install:local                          # Build and install rspec-stubbed_env-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rspec-stubbed_env against itse...
